...
document.querySelector("#swipe-container").addEventListener("touchstart", (e)=>{
    if(e.target.classList.contains("swipe-text")){
        ...
        restoreBtn.onclick = () => {
            ...
            Toastify({
                text: `${parentElement.textContent} was Restored!`,
                duration: 1500,
                gravity: "top",
                stopOnFocus: false,
                style: {
        ...
        delBtn.onclick = () => {
            ...
            parentElement.classList.add("del-animation");
            Toastify({
                text: `${parentElement.textContent} was Deleted Permanently!`,
                duration: 1500,
                gravity: "top",
                stopOnFocus: false,
                style: {
